...
public class Main {
    public static void main(String[] args) {
        ...
        Employee employee4 = new Employee(4, "Juliana", "HR", 75000);
        ...
        double salary1 = calculator.calculateSalary(employee1.getId());
        double salary2 = calculator.calculateSalary(employee2.getId());
        System.out.println("The salary " + employee1.getName() + " is: " + salary1);
        System.out.println("The salary " + employee2.getName() + " is: " + salary2);
    }
}
